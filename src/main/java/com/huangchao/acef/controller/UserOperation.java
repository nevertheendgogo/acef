...
public class UserOperation {
    ...
    //设置常用ip地址
    @RequestMapping(value = "/sui/{ipAddr}/{code}/{loginUserId}", produces = MediaType.TEXT_HTML_VALUE + ";charset=utf-8")
    public String setCommonIp(@PathVariable("ipAddr") String ipAddr, @PathVariable("code") String code, @PathVariable("loginUserId") String loginUserId, HttpServletRequest request, HttpServletResponse response) {
        return userService.setCommonIp(ipAddr, code, loginUserId, request, response);
    }
